...
def acquire_audio_lock(
    ...
    *,
    ...
    Args:
        ...
        lock_file: Override the lock-file path. Useful for tests so
            they can point at an isolated `tmp_path` without patching
            the module-level `LOCK_FILE` constant. Defaults to the
            module-level `LOCK_FILE`.
