...
# (project=scitex-audio, owner=ywatanabe1989, repo=scitex-audio,
...
TMPDIR="/tmp/publish-scitex_audio-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-audio dist/* uploaded to PyPI via manual OIDC trusted publishing"
